...
"""
Ranked validation and plotting for the V2 free-curve Transformer.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate V2 Transformer and save ranked best/typical/worst plots.",
...
def main() -> None:
    ...
    for folder in (plots_f_dir, plots_g_dir):
    ...
    selection_info = {
        ...
        "metric_notes": {
            ...
            "selection_bias": (
                "best 图是最好样本，不能代表总体性能；请同时生成 typical 或 representative。"
            ),
        },

...
# 使用逐项追加，避免某些 Windows PowerShell 环境解析数组末尾时出现 UnexpectedToken。
$TrainArgs = @()
...
Write-Host "Experiment 3: V2 shuffled sampling + 1000-point output + 5% training noise"
Write-Host "Pool:             $PoolDir"
Write-Host "Checkpoint:       $CheckpointDir"
Write-Host "Mode:             $Mode"
Write-Host "Input points:     100"
Write-Host "Output points:    1000"
Write-Host "Training noise:   5% RMS Gaussian"
